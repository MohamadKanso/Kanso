...
class TradingBot(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        # Add asset you would like to trade
        self.symbol = self.AddEquity("SPY", Resolution.Daily).Symbol
        
        # Number of days to look back to determine the breaking point
        self.lookback = 20
    ...
    #The OnData method is called everytime new data is recieved
